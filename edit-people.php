...
?>				
	...
	<div class="container">
		<div class="container" id="main">
			<h2>Update Post</h2>
			<div id="add-area">
				<form name="add-form" action="update-people.php" method="POST" enctype="multipart/form-data">
					<div class="form-inline">
						<input type="text" class="form-control" name="title" placeholder="Title" value="<?php echo $post['title']?>">
					</div>
					<div class="form-inline">
						<input type="text" class="form-control" name="firstname" id="firstname" placeholder="First name" value="<?php echo $people['first_name']?>">
						<input type="text" class="form-control" name="lastname" id="lastname" placeholder="Last name" value="<?php echo $people['last_name']?>">
					</div>
					<div class="form-inline">
					...
					<textarea class="form-control" rows="12" name="desc" placeholder="Description" ><?php echo $people['people_desc']?></textarea>
					<br>
					<div class="form-group">
					...
					<br>
					<button type="submit" class="btn btn-default" style="width: 250px" name="update" value="<?php echo $post['people_id'] ?>">Update Post</button>
				</form>
			</div>
		</div>
	</div>
